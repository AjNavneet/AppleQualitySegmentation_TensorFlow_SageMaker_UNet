...
class Data_Processing:
    ...
    def augmentation(self, X_train, X_test, y_train, y_test):
        seed = 24
        # Defining the ImageDataGenerator Parameters for images and masks:
        ...
        # Initialize ImageDataGenerator for images
        image_data_generator = ImageDataGenerator(**img_data_gen_args)
        image_data_generator.fit(X_train, augment=True, seed=seed)
        image_generator = image_data_generator.flow(X_train, seed=seed)
        valid_img_generator = image_data_generator.flow(X_test, seed=seed)

        # Initialize ImageDataGenerator for masks
    ...
    # Function to create a generator for images and masks
