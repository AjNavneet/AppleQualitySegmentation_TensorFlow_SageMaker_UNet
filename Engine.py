...
# Printing the Shapes of Images and Masks
...
images1 = preprocess_input1(images)  # Preprocess the Image data according to the 'Resnet34' specification
print(images1.shape)
print(masks.shape)
...
image_generator, valid_img_generator, mask_generator, valid_mask_generator = F2.augmentation(X_train, X_test, y_train, y_test)
